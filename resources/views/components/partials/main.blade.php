                ...
                <header class="relative w-full min-w-[min-content] border-b border-slate-100 bg-white py-2">
                    <div @class(['mx-auto flex items-center justify-between px-4', $maxWidth])>
                        ...
                        <a href="/" wire:navigate
                            ...
                            <img src="{{ $logoUrl }}" alt="" class="h-6 mb-1" />
                        </a>
                        <div class="justify-start hidden align-middle shrink grow basis-full lg:flex">
                            <div class="relative flex items-center w-full max-w-lg">
                                ...
                                <input type="text" name="" id=""
                                    class="w-full py-2 pr-4 font-medium border-0 rounded-full bg-slate-100 pl-14 ring-0 focus:ring-0" />
                            </div>
                        </div>
                ...
                <div class="relative gap-6 px-0 lg:px-4"
                    ...
                    <div class="overflow-hidden"
                        :class="{
                            ...
                            'fixed max-w-[300px] z-10 w-full left-0 top-[53px] h-[calc(100vh-53px)] bg-white': !
                                isAboveBreakPoint
                        }"
                        ...
                        <div class="box-border relative flex flex-col w-full overflow-hidden overflow-y-auto"
                            :class="{
                                'max-w-[256px]  h-[calc(100vh-229px)]': isAboveBreakPoint,
                                'max-w-[300px] w-full lg:max-w-[240px] bg-white p-2 h-[calc(100vh-135px)]': !
                                    isAboveBreakPoint
                            }"
                        ...
                        <div class="mx-2 lg:mx-0">
                            <div
                                class="relative bottom-0 flex items-center justify-between w-full p-2 border rounded-lg border-slate-200/20 lg:border-slate-200 bg-slate-200/30">
                                <div class="flex items-center">
                                    @if (!$hasAvatar)
                                        <button
                                            class="flex items-center justify-center w-12 h-12 p-1 text-lg font-medium text-blue-800 bg-blue-200 border border-blue-700 rounded-full">
                                            {{ $initials }}
                                        </button>
                                    @else
                                ...
                                <a href="{{ $settingsUrl }}"
                                    class="p-1 duration-200 rounded-full hover:bg-slate-300/50" wire:navigate>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="lm-scroll-hidden mt-4 grow overflow-hidden rounded-lg overflow-y-auto h-[calc(100vh-181px)]"
                        :class="{
