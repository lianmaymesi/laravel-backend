                ...
                <div class="flex items-center gap-x-3">
                    ...
                    @if ($columnsCount > 0)
                        <div class="relative flex items-center" x-data="{ showColumns: false }">
                            ...
                            <div class="absolute w-screen max-w-[260px] rounded-xl border bg-gray-100"
                                x-show="showColumns" x-anchor.bottom-start.offset.16="$refs.columns"
                                style="display: none;">
                                <div class="px-4 pb-6 pt-4" @click.away="showColumns = false">
                                    ...
                                    <div class="mt-4 grid gap-y-4">
                                        @foreach ($columns as $key => $column)
                                            <div>
                                                <x-lb::form.checkbox wire:model.live="selectedColumns"
                                                    :value="$column">
                                                    {{ ucfirst($column) }}
                                                </x-lb::form.checkbox>
                                            </div>
